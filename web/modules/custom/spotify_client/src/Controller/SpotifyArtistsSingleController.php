 ...
 */
class SpotifyArtistsSingleController extends ControllerBase {
  ...
  public function build(Request $request) {
    $id = $request->get('id');
    $build['artists_single_page'] = [
        '#theme'    => 'artists_single_page',
        '#artist' => $this->spotifyClientRequest->fetch('https://api.spotify.com/v1/artists/' . $id),
        '#tracks' => $this->spotifyClientRequest->fetch('https://api.spotify.com/v1/artists/' . $id . '/top-tracks?country=BR'),
    ];
    return $build;
  }
